...
Description :
    ...
    This is the class for the 'Module Database Process Window Arrangement b Button 124' process related methods.
...
public class filejavamodudataprocwindarrabbutt124 extends filejavamodudataclaswindarraabcdefghijklmnbase {

/*
Description :


    The 'Module Database Process Window Arrangement b Button 124' process manager method.
...
*/
    ...
    public static ArrayList<String> meth0PublStatArraListStri(ArrayList<String> locaArraListStriPara0) throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamodudataprocwindarrabbutt124.meth0PublStatArraListStri' started.");

            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamodudataprocwindarrabbutt124.meth0PublStatArraListStri started.");

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(0,"MDPWAbB124 0/6");
            ...
            if ((locaArraListStriPara0==null)||(locaArraListStriPara0.isEmpty()==true)||(locaArraListStriPara0.size()<4)||(locaArraListStriPara0.size()>5)) {
                ...
                System.out.println("The 'Module Database Process Window Arrangement b Button 124' process manager method.");

                System.out.println("The 'filejavamodudataprocwindarrabbutt124.meth0PublStatArraListStri' finished.");
            ...
            locaBoolStat0=filejavamodudataprocwindarrabbutt124.meth1PrivStatBool();

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(16,"MDPWAbB124 1/6");
            ...
            locaBoolStat0=filejavamodudataprocwindarrabbutt124.meth2PrivStatBool();

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(33,"MDPWAbB124 2/6");
            ...
            locaBoolStat0=filejavamodudataprocwindarrabbutt124.meth3PrivStatBool();

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(50,"MDPWAbB124 3/6");
            ...
            locaBoolStat0=filejavamodudataprocwindarrabbutt124.meth4PrivStatBool();

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(66,"MDPWAbB124 4/6");
            ...
            locaBoolStat0=filejavamodudataprocwindarrabbutt124.meth5PrivStatBool();

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(83,"MDPWAbB124 5/6");

            if (locaBoolStat0==false) {

                filejavamoduwindprocwindarraabcdefghijklmnmess.meth0PublStatBool("ERROR","The given 'SQL Server' SQL Database(s) Name(s) data listing query is empty.");

                filejavamoduloggproclogg.meth0PublStatBool("ERROR","The given 'SQL Server' SQL Database(s) Name(s) data listing query is empty.");

                System.out.println("\n'False End Case' : The given 'SQL Server' SQL Database(s) Name(s) data listing query is empty.");
            ...
            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(100,"MDPWAbB124 6/6");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamodudataprocwindarrabbutt124.meth0PublStatArraListStri.");
...
*/
    ...
    public static boolean meth1PrivStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamodudataprocwindarrabbutt124.meth1PrivStatBool' started.\nParameters :");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamodudataprocwindarrabbutt124.meth1PrivStatBool started.");
            ...
            if ((globProtStatArraListStriModuDataRecePara0.get(0)==null)||(globProtStatArraListStriModuDataRecePara0.get(1)==null)||(globProtStatArraListStriModuDataRecePara0.get(2)==null)||(globProtStatArraListStriModuDataRecePara0.get(3)==null)) {
                ...
                System.out.println("The 'filejavamodudataprocwindarrabbutt124.meth1PrivStatBool' finished.");
            ...
            if (globProtStatArraListStriModuDataRecePara0.size()==5) {
                ...
                if (globProtStatArraListStriModuDataRecePara0.get(4)==null) {
                    ...
                    System.out.println("'False End Case' : The given 'New SQL Database Name' : '"+globProtStatArraListStriModuDataRecePara0.get(4)+"' value is null.");
                ...
                if (globProtStatArraListStriModuDataRecePara0.get(4).length()<1) {
                    ...
                    System.out.println("'False End Case' : The given 'New SQL Database Name' : '"+globProtStatArraListStriModuDataRecePara0.get(4)+"' value has less length than the minimum.");
                ...
                if (globProtStatArraListStriModuDataRecePara0.get(4).length()>60) {

                    System.out.println("'False End Case' : The given 'New SQL Database Name' : '"+globProtStatArraListStriModuDataRecePara0.get(4)+"' value has more length than the maximum.");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamodudataprocwindarrabbutt124.meth1PrivStatBool.");
...
*/
    ...
    public static boolean meth2PrivStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamodudataprocwindarrabbutt124.meth2PrivStatBool' started.\nParameters :");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamodudataprocwindarrabbutt124.meth2PrivStatBool started.");
            ...
            if (locaBoolStat1==false) {
                ...
                System.out.println("The 'filejavamodudataprocwindarrabbutt124.meth2PrivStatBool' finished.");
            ...
            if (globProtStatArraListStriModuDataRecePara0.size()==5) {
                ...
                if (locaBoolStat1==false) {
                    ...
                    System.out.println("'False End Case' : The given 'New SQL Database Name' : '"+globProtStatArraListStriModuDataRecePara0.get(4)+"' value contains at least a 'Whitespace' character.");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamodudataprocwindarrabbutt124.meth2PrivStatBool.");
...
*/
    ...
    public static boolean meth3PrivStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamodudataprocwindarrabbutt124.meth3PrivStatBool' started:\nParameter :");

            System.out.println("The given 'Port Number' value in the beginning of the method : '"+globProtStatArraListStriModuDataRecePara0.get(1)+"'.");

            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamodudataprocwindarrabbutt124.meth3PrivStatBool started.");
            ...
            if (locaBoolStat1==false) {
                ...
                System.out.println("The 'filejavamodudataprocwindarrabbutt124.meth3PrivStatBool' finished.");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamodudataprocwindarrabbutt124.meth3PrivStatBool.");
...
*/
    ...
    public static boolean meth4PrivStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamodudataprocwindarrabbutt124.meth4PrivStatBool' started.\nParameters :");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamodudataprocwindarrabbutt124.meth4PrivStatBool started.");
            ...
            System.out.println("The 'filejavamodudataprocwindarrabbutt124.meth4PrivStatBool' finished.");

            return true;}

        catch (Exception locaExceCatcExce0) {

            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamodudataprocwindarrabbutt124.meth4PrivStatBool.");
...
Description :
    ...
    The given 'New SQL Database Name' matcher on the given 'Host Name' method.
...
*/
    ...
    public static boolean meth5PrivStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamodudataprocwindarrabbutt124.meth5PrivStatBool' started.\nParameters :");

            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamodudataprocwindarrabbutt124.meth5PrivStatBool started.");
            ...
            if (!(globProtStatResuSetQuerResu0.isBeforeFirst())) {
                ...
                System.out.println("'False End Case' : The given 'SQL Server' SQL Database(s) Name(s) data listing query is empty.");

                System.out.println("The given 'New SQL Database Name' matcher on the given 'Host Name' method.");

                System.out.println("The 'filejavamodudataprocwindarrabbutt124.meth5PrivStatBool' finished.");
            ...
            if (globProtStatArraListStriModuDataRecePara0.size()==4) {
                ...
                while (globProtStatResuSetQuerResu0.next()) {
                    ...
                    if (!((globProtStatResuSetQuerResu0.getString(1).equals("information_schema"))||(globProtStatResuSetQuerResu0.getString(1).equals("mysql"))||(globProtStatResuSetQuerResu0.getString(1).equals("performance_schema"))||(globProtStatResuSetQuerResu0.getString(1).equals("sys")))) {

                        System.out.println("Data match found :");

                        System.out.println("The 'SQL Database Name' : '"+globProtStatResuSetQuerResu0.getString(1)+"'.");
                ...
                while (globProtStatResuSetQuerResu0.next()) {
                    ...
                    if (!((globProtStatResuSetQuerResu0.getString(1).equals("information_schema"))||(globProtStatResuSetQuerResu0.getString(1).equals("mysql"))||(globProtStatResuSetQuerResu0.getString(1).equals("performance_schema"))||(globProtStatResuSetQuerResu0.getString(1).equals("sys")))&&(globProtStatResuSetQuerResu0.getString(1).contains(globProtStatArraListStriModuDataRecePara0.get(4)))) {

                        System.out.println("Data match found :");

                        System.out.println("The given 'New SQL Database Name' : '"+globProtStatArraListStriModuDataRecePara0.get(4)+"'.");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamodudataprocwindarrabbutt124.meth5PrivStatBool.");
