...
Description :
    ...
    This is the class for the 'Module Window Process Window Arrangement g Button 154' process related methods.
...
public class filejavamoduwindprocwindarragbutt154 extends filejavamoduwindclaswindarraabcdefghijklmnbase {

/*
Description :


    The 'Module Window Process Window Arrangement g Button 154' process manager method.
...
*/
    ...
    public static boolean meth0PublStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamoduwindprocwindarragbutt154.meth0PublStatBool' started.");

            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamoduwindprocwindarragbutt154.meth0PublStatBool started.");

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(0,"MWPWAgB154 0/3");

            boolean locaBoolStat0=false;

            locaBoolStat0=filejavamoduwindprocwindarragbutt154.meth1PrivStatBool();

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(33,"MWPWAgB154 1/3");
            ...
            if (locaBoolStat0==false) {
                ...
                System.out.println("The 'Module Window Process Window Arrangement g Button 154' process manager method.");

                System.out.println("The 'filejavamoduwindprocwindarragbutt154.meth0PublStatBool' finished.");

                return false;}

            locaBoolStat0=filejavamoduwindprocwindarragbutt154.meth2PrivStatBool();

            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(66,"MWPWAgB154 2/3");
            ...
            filejavamoduwindprocwindarraabcdefghijklmnprogbar004.meth0PublStatBool(100,"MWPWAgB154 3/3");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamoduwindprocwindarragbutt154.meth0PublStatBool.");
...
*/
    ...
    public static boolean meth1PrivStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamoduwindprocwindarragbutt154.meth1PrivStatBool' started.\nParameters :");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamoduwindprocwindarragbutt154.meth1PrivStatBool started.");
            ...
            if ((globProtStatJTexFielPosi111.getText()==null)||(globProtStatJTexFielPosi113.getText()==null)||(globProtStatJTexFielPosi121.getText()==null)) {
                ...
                System.out.println("The 'filejavamoduwindprocwindarragbutt154.meth1PrivStatBool' finished.");
            ...
            if ((globProtStatJTexFielPosi111.getText().length()>120)||(globProtStatJTexFielPosi113.getText().length()>120)||(globProtStatJTexFielPosi121.getText().length()>120)) {
            ...
            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamoduwindprocwindarragbutt154.meth1PrivStatBool.");
...
*/
    ...
    public static boolean meth2PrivStatBool() throws Exception {
        ...
        try {
            ...
            System.out.println("\nThe 'filejavamoduwindprocwindarragbutt154.meth2PrivStatBool' started.\nParameters :");
            ...
            filejavamoduloggproclogg.meth0PublStatBool("INFO","The filejavamoduwindprocwindarragbutt154.meth2PrivStatBool started.");
            ...
            System.out.println("The 'filejavamoduwindprocwindarragbutt154.meth3PrivStatBool' finished.");

            return true;}

        catch (Exception locaExceCatcExce0) {

            filejavamoduloggproclogg.meth0PublStatBool("ERROR","EXCEPTION in filejavamoduwindprocwindarragbutt154.meth2PrivStatBool.");
